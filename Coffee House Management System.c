...
int main(){
	...
	system("title COFFEE HOUSE Management System");
	...
	if((main_menu_choice >=1 && main_menu_choice <=3)){
		...
		if(main_menu_choice == 1){
			...
			cls();
			middle1(); pre(3); printf("Thanks For Visiting..\n\n");
			Sleep(1000);
			pre(3); printf("We are waiting for you ....\n\n");
			Sleep(1500);
			exit(1);
